...
function hipotenusaTr (cateto1, cateto2){ //a^2 + b^2 = c^2
    hipotenusaTr = (cateto1**2) + (cateto2**2);
    console.log(`La hipotenusa de un triangulo rectangulo el cual tiene un cateto opuesto de ${cateto1} y un adyacentye de ${cateto2} es igual a ${hipotenusaTr}`)
}
hipotenusaTr(3, 4);
